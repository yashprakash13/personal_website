...
const LinkSingle = ({ text }) => {
  return (
    <div className="z-20 group px-2 py-1 md:px-3 md:py-2 lg:px-5 lg:py-2 font-sans rounded-md hidden md:flex justify-between items-center gap-4 bg-white border-2 border-black opacity-30 hover:bg-transparent hover:border-white hover:opacity-90 transition-all duration-1000">
